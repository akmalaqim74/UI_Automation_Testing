...
public class personalInfoLogic extends baseTest{
    ...
    void nameField(){
        Allure.step("Step : Find Marital Status  Field", () -> {
        ...
        Allure.step("Test 2: Alphabet with selected special characters such as \"\"@/().-,’\"", () -> {
            ...
            Allure.step("2. Fill in the necessary field to go next",()->{
                 });
